...
Page({
  ...
  turnToDetail : function(event) {
    ...
    app.turnToPage('/pages/communityDetail/communityDetail?detail=' + id + '&articleStyle=' + article_style + '&dataLiked=' + dataLiked + '&phoneNumber=' + phoneNumber + '&sectionid=' + communityId);
  },
  ...
  turnToPublish : function(event) {
    app.turnToPage('/pages/communityPublish/communityPublish?detail=' + this.data.communityId + '&reqAudit=' + this.data.communityInfo.require_audit );
  },

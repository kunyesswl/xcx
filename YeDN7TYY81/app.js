...
App({
  ...
  turnToNewsDetail: function (event) {
    let id = event.currentTarget.dataset.id;
    this.turnToPage('/pages/newsDetail/newsDetail?detail=' + id);
  },
...
    return  s;
  ...
  globalData:{
    appId: 'YeDN7TYY81',
        tabBarPagePathArr: '["/pages/l53G5u63lm_page10000/l53G5u63lm_page10000","/pages/l53G5u63lm_page10001/l53G5u63lm_page10001","/pages/l53G5u63lm_page10024/l53G5u63lm_page10024","/pages/tabbarShoppingCart/tabbarShoppingCart","/pages/l53G5u63lm_page10003/l53G5u63lm_page10003"]',
        homepageRouter: 'l53G5u63lm_page10000',
    formData: null,
    userInfo: {},
    systemInfo: null,
    sessionKey: '',
    ...
    siteBaseUrl: 'https://xcx.zhichiweiye.cn',
    appTitle: '仿美丽说小程序（拼团+秒杀）2',
    appDescription: '我的应用',

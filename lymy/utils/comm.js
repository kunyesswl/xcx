...
const getAllPermission = () => {
  return [{ "id": 1, "functionName": "内部公告" }, { "id": 2, "functionName": "商铺信息" }, { "id": 3, "functionName": "请假调休" }, { "id": 4, "functionName": "审批查询" }, { "id": 5, "functionName": "合同签署" }, { "id": 6, "functionName": "报修查看" }, { "id": 7, "functionName": "意见反馈" }, { "id": 8, "functionName": "公告发布" }, { "id": 9, "functionName": "员工权限" }, { "id": 10, "functionName": "登录查询" }, { "id": 11, "functionName": "广告配置" },];
}
module.exports = {
